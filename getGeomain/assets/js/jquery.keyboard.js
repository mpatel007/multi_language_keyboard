	...
	base.reveal = function (redraw) {
		...
		$('#multi').on('click',function(){
			...
			base.$keyboard.show();
                  ...
                  $('.ui-keyboard-preview-wrapper input').attr('placeholder','Enter Geomain and click Accept');
                  $('.ui-keyboard-preview-wrapper input').css({'font-size':'15px'});
...
//                        console.log(base.$preview);
			...
			$('<div />')
				...
				.append(base.$preview)
                        ...
                        $('<div>')
				.addClass(kbcss.wrapper)
				.append('<span id="close_keyboard" onclick="this.parentNode.parentNode.parentNode.removeChild(this.parentNode.parentNode);">x</span><h2 id="mydiv" style="font-size:14px;color:#000;"> Click to drag </h2>')
                                .prependTo(base.$keyboard);
